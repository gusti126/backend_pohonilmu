                ...
                <div class="card p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="Masukan judul kelas ..." name="nama" value="{{ $kelas->nama }}">
                        </div>
                        <div class="col-md-6">
                            <label for="">Price Kelas</label>
                            <input type="number" class="form-control" placeholder="Masukan harga kelas ..." name="harga" value="{{ $kelas->harga  }}">
                        </div>
                        <div class="col-md-12">
                            <label for="">Deskripsi</label>
                            <textarea name="deskripsi" id="" cols="30" rows="10" class="form-control">{{  $kelas->deskripsi  }}</textarea>
                        </div>
                        <div class="col-4">
                            <button type="submit" class="btn btn-primary my-3 btn-block">Simpan Perubahan</button>
                        </div>
                    </div>
                </div>
            </form>
